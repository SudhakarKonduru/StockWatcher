...
public class StockWatcher implements EntryPoint {
	...
	private void updateTable(StockPrice stockPrice) {
		...
		int row = stocks.indexOf(stockPrice.getSymbol());
		...
		stocksFlexTable.setText(row+1, 1, priceText);
		//stocksFlexTable.setText(row+1, 2, changeText + " (" + changePercentText + "%)");
		Label changeWidget = (Label) stocksFlexTable.getWidget(row+1, 2);
